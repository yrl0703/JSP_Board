      ...
      <div class="relative max-w-screen-2xl px-4 py-0 mx-auto sm:px-6 sm:py-12 lg:pt-0 lg:pb-0 lg:px-40">
        <div class=" mt-0 flex">
          ...
          <div  class="hidden space-y-4 pt-7 pb-10 lg:block sticky top-20 h-full min-w-[340px] pr-10 md:hidden">
                   ...
                   <ul class="p-4 space-y-1 border-t border-gray-200 flex flex-wrap">
                     <li class="w-6/12 mt-1">
                       <label class="inline-flex items-center gap-2">
                         <input
                           type="checkbox"
                           name="filter" id="filter" value="'탁주'"
                     ...
                     <li class="w-6/12">
                       <label class="inline-flex items-center gap-2">
                         <input
                           type="checkbox"
                           name="filter" id="filter" value="'약주'"
                           class="w-5 h-5 border-gray-300 rounded"
                         /> 
                         <span class="text-sm font-medium text-gray-700">
                          약·청주
                     ...
                     <li class="w-6/12">
                       <label class="inline-flex items-center gap-2">
                         <input
                           type="checkbox"
                           name="filter" id="filter" value="'과실주'"
                           class="w-5 h-5 border-gray-300 rounded"
                         /> 
                         <span class="text-sm font-medium text-gray-700">
                           과실주
                     ...
                     <li class="w-6/12">
                       <label class="inline-flex items-center gap-2">
                         <input
                           type="checkbox"
                           name="filter" id="filter" value="'증류주'"
                           class="w-5 h-5 border-gray-300 rounded"
                         /> 
                         <span class="text-sm font-medium text-gray-700">
                           증류주
                     ...
                     <li class="w-6/12">
                       <label class="inline-flex items-center gap-2">
                         <input
                           type="checkbox"
                           name="filter" id="filter" value="'기타주류'"
                           class="w-5 h-5 border-gray-300 rounded"
                         /> 
                         <span class="text-sm font-medium text-gray-700">
                           기타주류
                  ...
                  <ul class="p-4 space-y-1 border-t border-gray-200 flex flex-wrap">
                    <li class="w-6/12 mt-1">
                      ...
                      >
                        <input
                          type="checkbox"
                          name="filter" id="filter" value="웃어른"
                          class="w-5 h-5 border-gray-300 rounded"
                        />
                    ...
                    <li class="w-6/12">
                      ...
                      >
                        <input
                          type="checkbox"
                          name="filter" id="filter" value="연인"
                          class="w-5 h-5 border-gray-300 rounded"
                        />
            ...
            <button onclick=filterSearch() class="sticky mt-4 w-20 p-2 text-sm font-medium transition bg-gray-500 rounded text-white ">
                검색
              </button>
		...
		<c:if test="${pgList.count > 0}">
            <ol class="flex justify-center gap-1 mt-8 text-xs font-medium">            
              ...
              <li>
                <a
                  href="/KIC4_Project3/product.shop?pageNum=${pgList.startPage-pgList.blockSize}&pcategory=${pcategory}"
              ...
              <c:choose>
              	<c:when test="${pgList.currentPage==i}">
              		<a href="/KIC4_Project3/product.shop?pageNum=${i}&pcategory=${pcategory}" class="block w-8 h-8 leading-8 text-center border border-gray-100 text-white bg-gray-900 rounded">
		                 ${i}
		             </a>
              	</c:when>
              	<c:otherwise>
		                <a
		                  href="/KIC4_Project3/product.shop?pageNum=${i}&pcategory=${pcategory}"
